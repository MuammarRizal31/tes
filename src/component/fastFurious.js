class FastFurious extends HTMLElement {
  constructor() {
    super();
    this.urlMovies = "http://www.omdbapi.com/?apikey=41d03a10&s=fast furious";
  }
  connectedCallback() {
    this.render();
  }
...
customElements.define("cards-fast-furious", FastFurious);
